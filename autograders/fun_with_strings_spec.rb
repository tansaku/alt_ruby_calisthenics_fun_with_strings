describe 'palindrome detection' do
  ...
  it 'should be case-insensitive [10 points]', points: 10 do
    'ReDivider'.should be_a_palindrome
  end
  it 'should ignore nonword characters [10 points]', points: 10 do
...
describe 'word count' do
  it 'should return a hash [5 points]', points: 5 do
    'now is the time'.count_words.should be_a_kind_of Hash
  end
  it 'works on simple strings [10 points]', points: 10 do
    'Doo bee doo bee doo'.count_words.should ==
      {'doo' => 3, 'bee' => 2}
  end
  it 'ignores punctuation [5 points]', points: 5 do
    'A man, a plan, a canal -- Panama!'.count_words.should ==
      {'man' => 1, 'plan' => 1, 'canal' => 1, 'a' => 3, 'panama' => 1}
  end
  it 'works on the empty string [10 points]', points: 10 do
    ''.count_words.should ==  {}
  end
  it 'ignores leading whitespace [10 points]', points: 10 do
    "  toucan".count_words.should ==
      {'toucan' => 1 }
  end
  it 'ignores embedded whitespace [10 points]', points: 10 do
...
describe 'anagram grouping' do
  describe 'sanity checks' do
    it 'should work on the empty string [5 points]', points: 5 do
      ''.anagram_groups.should == []
    end
    it 'should return an array of arrays for nonempty string [5 points]', points: 5 do
      'x'.anagram_groups.each { |element| element.should be_an Array }
    end
  end
  it 'for "scream cars for four scar creams" [10 points]', points: 10 do
